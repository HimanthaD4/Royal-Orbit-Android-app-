...
public class ReservedHallDetailsQueen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reserved_hall_details_queen);
        ...
        btn_delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                openMenu();
                Toast.makeText(ReservedHallDetailsQueen.this, "Delete Successful", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void openUpdateQueenCourt(){
        Intent intent =  new Intent(this, UpdateQueenCourt.class);
